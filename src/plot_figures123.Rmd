...
```{r}
load("../BCD_5_locations.RData")
bcd05 <- result_list
load("../BCD_10_locations.RData")
bcd10 <- result_list
load("../BCD_15_locations.RData")
bcd15 <- result_list
load("../BCD_20_locations.RData")
bcd20 <- result_list
load("../BCD_25_locations.RData")
bcd25 <- result_list
...
temp<- Reduce(union, lapply(visited, function(x) x$handled_event_locations))
